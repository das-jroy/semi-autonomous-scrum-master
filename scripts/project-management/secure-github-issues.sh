...
**Objective:** Configure the GitHub project board for tracking $PROJECT_NAME
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            cat << 'EOF'
🔒 Secure GitHub Issues Generator for $PROJECT_NAME
...
DESCRIPTION:
    This script securely converts TODO items in the $PROJECT_NAME
