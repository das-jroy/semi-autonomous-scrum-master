...
echo "🎯 Azure InfraWeave Project Automation Summary"
echo "=============================================="
echo ""
...
show_resources() {
    ...
    echo "   • Repository: https://github.com/$REPO_OWNER/vanguard-az-infraweave-catalog"
    echo "   • Issues: https://github.com/$REPO_OWNER/vanguard-az-infraweave-catalog/issues"
    echo ""
...
main() {
    ...
    echo ""
    echo -e "${YELLOW}The Azure InfraWeave project is now fully automated with:${NC}"
