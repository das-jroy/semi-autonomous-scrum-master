...
if [[ $# -lt 1 ]]; then
    ...
    echo "  $0 apply-template aws dasdigitalplatform aws-infraweave-catalog"
...
create_project_template() {
    ...
    case "$cloud_provider" in
        ...
        "azure")
            MODULE_CATEGORIES='["Foundation","Compute","Storage","Networking","Database","Monitoring","Security","Containers"]'
            TEMPLATE_DESCRIPTION="Azure InfraWeave Module Catalog - Production-ready Terraform modules for Azure infrastructure with Platform 2.0 security"
            ;;
        "gcp")
            MODULE_CATEGORIES='["Foundation","Compute","Storage","Networking","Database","Monitoring","Security","Containers"]'
