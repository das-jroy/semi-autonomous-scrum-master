...
echo "🗺️ Azure InfraWeave Roadmap Status Report"
echo "=========================================="
echo ""
...
REPO_URL="https://github.com/$REPO_OWNER/vanguard-az-infraweave-catalog"
...
main() {
    ...
    echo ""
    echo -e "${YELLOW}The Azure InfraWeave project is progressing well with:${NC}"
