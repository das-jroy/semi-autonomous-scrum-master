...
gh issue list --repo dasdigitalplatform/vanguard-az-infraweave-catalog \
    --label "priority: high" \
    --state open \
    --limit 5 \
...
echo ""
echo "🔗 View Links:"
echo "• Detailed Dashboard: https://github.com/orgs/dasdigitalplatform/projects/3/views/1"
echo "• Category View: https://github.com/orgs/dasdigitalplatform/projects/3/views/2"
echo "• Sprint Board: https://github.com/orgs/dasdigitalplatform/projects/3/views/4"
EOF
...
total_issues=$(gh issue list --repo dasdigitalplatform/vanguard-az-infraweave-catalog --state open --limit 100 --json number | jq length)
...
priority_labeled=$(gh issue list --repo dasdigitalplatform/vanguard-az-infraweave-catalog --state open --label "priority:" --limit 100 --json number | jq length)
echo "• Issues with Priority: $priority_labeled/$total_issues"

# Check status labels  
status_labeled=$(gh issue list --repo dasdigitalplatform/vanguard-az-infraweave-catalog --state open --label "status:" --limit 100 --json number | jq length)
echo "• Issues with Status: $status_labeled/$total_issues"

# Check category labels
category_labeled=$(gh issue list --repo dasdigitalplatform/vanguard-az-infraweave-catalog --state open --label "module-category:" --limit 100 --json number | jq length)
...
for status in "${statuses[@]}"; do
    count=$(gh issue list --repo dasdigitalplatform/vanguard-az-infraweave-catalog --state open --label "status:$status" --limit 100 --json number | jq length)
...
review_count=$(gh issue list --repo dasdigitalplatform/vanguard-az-infraweave-catalog --state open --label "status:review" --limit 100 --json number | jq length)
blocked_count=$(gh issue list --repo dasdigitalplatform/vanguard-az-infraweave-catalog --state open --label "status:blocked" --limit 100 --json number | jq length)
