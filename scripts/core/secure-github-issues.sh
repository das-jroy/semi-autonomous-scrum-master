...
# Secure GitHub Issue Generator for Azure InfraWeave Catalog TODOs
# This script safely converts TODOs into GitHub issues with proper security controls

set -e

echo "🔒 Secure Azure InfraWeave Catalog - GitHub Issue Generator"
echo "=========================================================="
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            cat << 'EOF'
🔒 Secure GitHub Issues Generator for Azure InfraWeave Catalog
...
DESCRIPTION:
    This script securely converts TODO items in the Azure InfraWeave catalog
...
PREREQUISITES:
    ...
    2. Access to dasdigitalplatform/vanguard-az-infraweave-catalog repository
...
TARGET:
    Repository: dasdigitalplatform/vanguard-az-infraweave-catalog
    Project:    https://github.com/orgs/dasdigitalplatform/projects/3
