...
echo "------------------------"
echo "1. Go to: https://github.com/orgs/dasdigitalplatform/projects/$PROJECT_NUMBER"
...
if [[ $create_defaults =~ ^[Yy]$ ]]; then
    ...
    cat > /Users/za497e/IdeaProjects/vanguard-az-infraweave-catalog/scripts/set-field-defaults.sh << 'EOF'
#!/bin/bash
...
EOF
    ...
    chmod +x /Users/za497e/IdeaProjects/vanguard-az-infraweave-catalog/scripts/set-field-defaults.sh
