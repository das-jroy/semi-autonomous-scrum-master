...
echo "🎯 $PROJECT_NAME Project Views"
echo "================================="
echo ""
...
case $choice in
    1) echo "Opening Priority View..."; open "https://github.com/orgs/$REPO_OWNER/projects/3/views/1" ;;
    2) echo "Opening Category View..."; open "https://github.com/orgs/$REPO_OWNER/projects/3/views/2" ;;
    3) echo "Opening Security Review..."; open "https://github.com/orgs/$REPO_OWNER/projects/3/views/3" ;;
    4) echo "Opening Sprint Board..."; open "https://github.com/orgs/$REPO_OWNER/projects/3/views/4" ;;
    5) echo "Opening Roadmap View..."; open "https://github.com/orgs/$REPO_OWNER/projects/3/views/5" ;;
    *) echo "Invalid choice. Opening main project board..."; open "https://github.com/orgs/$REPO_OWNER/projects/3" ;;
esac
EOF
