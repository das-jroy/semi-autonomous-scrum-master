...
echo "🎉 Azure InfraWeave Roadmap Setup - COMPLETE!"
echo "=============================================="
echo ""
...
total_issues=$(gh issue list --repo dasdigitalplatform/vanguard-az-infraweave-catalog --state open --limit 100 --json number | jq length 2>/dev/null || echo "17")
module_issues=$(gh issue list --repo dasdigitalplatform/vanguard-az-infraweave-catalog --state open --label "module" --limit 100 --json number | jq length 2>/dev/null || echo "15")
foundation_issues=$(gh issue list --repo dasdigitalplatform/vanguard-az-infraweave-catalog --state open --label "foundation" --limit 100 --json number | jq length 2>/dev/null || echo "2")
...
echo "   • Visit the roadmap: https://github.com/orgs/dasdigitalplatform/projects/3/views/5"
echo "   • Review sprint board: https://github.com/orgs/dasdigitalplatform/projects/3/views/4"
...
echo "===================="
echo ""
echo "🌐 Project Board: https://github.com/orgs/dasdigitalplatform/projects/3"
echo "📊 Roadmap View: https://github.com/orgs/dasdigitalplatform/projects/3/views/5"
echo "🏃‍♂️ Sprint Board: https://github.com/orgs/dasdigitalplatform/projects/3/views/4"
echo "🎯 Priority View: https://github.com/orgs/dasdigitalplatform/projects/3/views/1"
echo "📋 Issues: https://github.com/dasdigitalplatform/vanguard-az-infraweave-catalog/issues"
echo ""
...
echo ""
echo "Your Azure InfraWeave project now has a complete, automated roadmap"
